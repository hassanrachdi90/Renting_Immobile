...
namespace Renting_Immobile.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult FinalizeBooking(int villaId, String checkInDate, int nights)
        {
            ...
            DateTime parsedDate;
            DateTime.TryParseExact(checkInDate, "dd/MM/yyyy", null, System.Globalization.DateTimeStyles.None, out parsedDate);
            ...
            Booking booking = new()
            {
                ...
                CheckInDate = DateOnly.FromDateTime(parsedDate),
                Nights = nights,
                CheckOutDate = DateOnly.FromDateTime(parsedDate).AddDays(nights),
                UserId = userId,
        ...
        private List<int> AssignAvailableVillaNumberByVilla(int villaId)
        {
            ...
            var checkedInVilla = _unitOfWork.Booking.GetAll(u => u.VillaId == villaId && u.Status == SD.StatusChechedIn).Select(u=>u.VillaNumber) ;
        ...
        {
            _unitOfWork.Booking.UpdateStatus(booking.Id, SD.StatusChechedIn, booking.VillaNumber);
            _unitOfWork.Save();
